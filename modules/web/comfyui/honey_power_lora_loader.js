...
console.log("[HoneyPowerLoraLoader] JS file loaded");

class HoneyPowerLoraLoaderFrontend extends RgthreeBaseServerNode {
...
HoneyPowerLoraLoaderFrontend.title = "HoneyPowerLoraLoader";
HoneyPowerLoraLoaderFrontend.type = "HoneyPowerLoraLoader";
HoneyPowerLoraLoaderFrontend.comfyClass = "HoneyPowerLoraLoader";

HoneyPowerLoraLoaderFrontend[_a] = {
    type: "combo",
    values: [PROP_VALUE_SHOW_STRENGTHS_SINGLE, PROP_VALUE_SHOW_STRENGTHS_SEPARATE],
};
HoneyPowerLoraLoaderFrontend[_b] = {
    type: "string",
};
...
const NODE_CLASS = HoneyPowerLoraLoaderFrontend;
// app.registerExtension({
//     name: "honey.PowerLoraLoader",
...
app.registerExtension({
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        if (nodeData.name === "HoneyPowerLoraLoader") {
            console.log("[HoneyPowerLoraLoader] Found backend node:", nodeData.name);
            console.log("[HoneyPowerLoraLoader] Setting up frontend override");
            NODE_CLASS.setUp(nodeType, nodeData);
        }
    },
});